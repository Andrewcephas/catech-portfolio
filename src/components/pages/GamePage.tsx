...
const GamePage = () => {
  ...
  }, [moveSnake, speed, gameRunning, gameOver]);
  ...
  return (
    <div className="h-full space-y-6 overflow-y-auto animate-fade-in p-4">
      {/* Header */}
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 flex items-center justify-center">
          <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-lg">
            <div 
              className="relative bg-gray-900 border-2 border-[#017020] rounded-lg overflow-hidden mx-auto"

...
const Hero = ({ onNavigateToPage }: HeroProps) => {
  ...
  const handleNavigation = (pageIndex: number) => {
    if (onNavigateToPage) {
      ...
      const event = new CustomEvent('navigateToPage', { detail: pageIndex });
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative">
      ...
      <button
        ...
        className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce bg-transparent border-none text-gray-400 hover:text-white transition-colors"
